            ...
            get
            {
                return new List<Drink>
                {
                    new Drink {
                        ...
                        ImageThumbnailUrl = "~/images/download.jpg"
                    },
                    new Drink {
                        Name = "Rum & Coke",
                        ...
                        ImageThumbnailUrl = "~/images/download1.jpg"
                    },
                    new Drink {
                        Name = "Tequila ",
                        ...
                        Category =  _categoryRepository.Categories.First(),
                        ImageUrl = "~/images/download2.jpg",
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "~/images/download2.jpg"
                    },
                    new Drink
                    {
                        Name = "Juice ",
                        ...
                        ImageUrl = "~/images/download3.jpg",
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "~/images/download3.jpg"
                    }
                };
            }
        }
